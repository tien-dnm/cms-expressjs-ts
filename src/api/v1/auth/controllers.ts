...
} from "../refresh_token/methods";
import User from "../user/model";
import { generateToken, decodeToken, verifyPassword } from "./methods";
...
export const refreshToken = async (req: Request, res: Response) => {
  try {
    ...
    const decoded = (await decodeToken(accessTokenFromHeader)) as JwtPayload;
